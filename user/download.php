...
if($_GET['my']=='install'){
    ...
    $DB->query("insert into `auth_down` (`type`,`authcode`,`sign`,`date`,`ip`) values ('用户获取|安装包','".$authcode."','".$sign."','".$date."','".$clientip."')");
    ...
    $DB->query("insert into `auth_down` (`type`,`authcode`,`sign`,`date`,`ip`) values ('用户获取|更新包','".$authcode."','".$sign."','".$date."','".$clientip."')");
}
